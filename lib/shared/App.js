...
var App = function App() {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: _routes.HELLO_PAGE_ROUTE, render: function render() {
          return _react2.default.createElement(_hello2.default, null);
        } }),
      _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: _routes.HELLO_ASYNC_PAGE_ROUTE, render: function render() {
